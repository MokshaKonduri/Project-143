...
function startGame() {
  gameStatus="start"; 
  document.getElementById("status").innerHTML="The Game is loading. Please wait.";
}
...
console.log(gameStatus);
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press the Play Button to start the very exciting Mario Game ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
